...
FOUNDATION_EXTERN NSString *AKItemTypeGetName(AKItemType type);
 ...
 */
@property (nonatomic, strong, readonly) NSArray<AKSubtitle *> *subtitles;
 ...
 */
@property (nonatomic, copy, readonly) AKIcon *icon;
 ...
 */
@property (nonatomic, strong, readonly) NSArray<AKModifier *> *mods;
- (AKModifier *)setMod:(AKModKey)mod subtitle:(NSString *)subtitle arg:(NSString *)arg;
 ...
 */
@property (nonatomic, strong, readonly) AKText *onCopyText;
- (void)setCopyText:(NSString *)text;
@property (nonatomic, strong, readonly) AKText *onLargeText;
 ...
 */
@property (nonatomic, copy) NSString *quicklookurl;
